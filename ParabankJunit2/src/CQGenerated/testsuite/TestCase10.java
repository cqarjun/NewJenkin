...
public class TestCase10
{
	...
	public void step9()
	{
		...
		"Account Number",
		/**Amount*/
		"Amount greater than the account balance",
		/**From_Account*/
		"From Account"
		)
		)
	...
	{
		CQData.setUp();
		CQTestSuite.harness.setUp("Bill Pay Amount should be less than the account balance");
	}
	@After
	public void tearDown()
	{
		CQTestSuite.harness.tearDown("Bill Pay Amount should be less than the account balance");
	}
}
